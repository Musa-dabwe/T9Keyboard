...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun updateToggle(imageView: ImageView, isEnabled: Boolean) {
        if (isEnabled) {
            ...
            androidx.core.widget.ImageViewCompat.setImageTintList(imageView, ColorStateList.valueOf(ContextCompat.getColor(this, accentColors[preferences.accentColorIndex])))
        } else {
